    ...
    <div className="min-h-screen pt-24 pb-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <Card>
            <CardHeader>
              <CardTitle>Mes jardins</CardTitle>
            ...
            <CardContent>
              {myGardens.length > 0 ? (
                    ...
                    <div key={garden.id} className="border rounded-lg overflow-hidden">
                      ...
                      <div className="p-4">
                        ...
                        <Button asChild className="w-full">
                          <Link to={`/gardens/${garden.id}/manage`}>
                            Gérer ce jardin
                          </Link>
                        </Button>
                      </div>
                ...
                <div className="text-center py-8">
                  <p className="text-muted-foreground mb-4">Vous n'avez pas encore de jardin</p>
                  <Button asChild>
                    <Link to="/add-garden">Ajouter un jardin</Link>
                  </Button>
                </div>
              )}
            </CardContent>
